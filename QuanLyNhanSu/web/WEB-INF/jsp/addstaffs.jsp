...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto my-2 my-lg-0">
                    ...
                    <li class="nav-item">
                        <a href="addstaffs.htm?lang=en">English</a> | <a href="addstaffs.htm?lang=vi">Việt Nam</a>
                    </li>
                    <div class="dropdown">
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end" style="height: 150%">
                        <h1 class="text-uppercase text-white font-weight-bold" style="padding-left: 60px; padding-top: 100px; padding-bottom: 24px"><spring:message code="lable.home.li3" text="THÊM NHÂN VIÊN"/></h1>
                        ...
                        <div class="form" style="font-family: Times New Roman;">
                            ...
                            <form:form action="addstaffs.htm" method="post" modelAttribute="staffins" role="form" class="contactForm">
                                <c:set var="staffins" value="${staffins}"></c:set>
                                    <div class="form-row" style="color: red;" >
                                        <div class="form-group col-md-6">
                                            <input readonly=""  type="text" name="id" value="${staffins.id}" class="form-control" id="name" placeholder="<spring:message code="fi.a1" text="Mã số"/>" data-rule="minlen:1" data-msg="Vui lòng nhập mã số" />
                                        <div class="validation"></div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <input type="text" class="form-control" name="name" value="${staffins.name}" id="email" placeholder="<spring:message code="fi.a2" text="Họ tên"/>" data-rule="minlen:1" data-msg="Vui lòng nhập họ tên" />
                                        <div class="validation"></div>
                                    </div>
                                </div>
                                <div class="form-row" style="color: red">
                                    ...
                                    <div class="form-group col-md-6">
                                        <input type="text" class="form-control" name="birthday" value="${staffins.birthday}" id="email" placeholder="<spring:message code="fi.a4" text="Ngày sinh"/>" data-rule="minlen:10" data-msg="Vui lòng nhập ngày sinh" />
                                        <div class="validation"></div>
                                    </div>
                                </div> 
                                ...
                                <div class="form-row" style="color: red">
                                    <div class="form-group col-md-6">
                                        <input onchange="readURL(this)" type="file" name="photo" value="${staffins.photo}" class="form-control" data-rule="minlen:1" id="name" data-msg="<spring:message code="fi.a5" text="Hình ảnh"/>" />
                                        <div class="validation"></div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <input type="email" class="form-control" name="email" value="${staffins.email}" id="email" placeholder="Email" data-rule="email" data-msg="<spring:message code="fi.a6" text="Email"/>" />
                                        <div class="validation"></div>
                                    </div>
                                </div> 
                                <div class="form-row" style="color: red">
                                    <div class="form-group col-md-6">
                                        <input type="text" name="phone" value="${staffins.phone}"class="form-control" id="name" placeholder="<spring:message code="fi.a7" text="Số điện thoại"/>" data-rule="minlen:10" data-msg="Vui lòng nhập số điện thoại" />
                                        <div class="validation"></div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <input type="text" class="form-control" name="salary" value="${staffins.salary}" id="email" placeholder="<spring:message code="fi.a8" text="Lương"/>" data-rule="minlen:6" data-msg="Vui lòng nhập lương" />
                                        <div class="validation"></div>
                                    </div>
                                </div> 
                                <div class="form-row" style="color: red">
                                    <div class="form-group col-md-6">
                                        <input type="text" name="notes" value="${staffins.notes}" class="form-control" id="name" placeholder="Ghi chú" data-msg="<spring:message code="fi.a9" text="Ghi chú"/>" />
                                        <div class="validation"></div>
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-row" style="color: red">
                                    ...
                                    <div class="text-center" style="padding-left: 389px; padding-top: 24px; padding-bottom: 24px;"><button class="btn btn-outline-success my-2 my-sm-0" name="btnInsert" type="submit"><spring:message code="btn.add" text="Thêm"/> </button> &nbsp;&nbsp;&nbsp;<button class="btn btn-outline-success my-2 my-sm-0" name="btnReset" type="submit"><spring:message code="btn.add5" text="Làm mới"/></button></div>
                                </div> 
                            </form:form>
    ...
    <table class="bordered" id="dataTable" width="100%" cellspacing="0" style="margin-left: -1px">
        ...
        <tbody>
            <c:forEach var="b" items="${staffsins}">
                <tr>
                    <td>${b.id}</td>
                    <td>${b.name}</td>
                    <td>${b.gender}</td>
                    ...
                    <td>${b.departId}</td>
                    <td>${b.capdo}</td>
                    <td><a href="updatestaffs.htm?lnkEdit&id=${b.id}">Sửa</a></td>
                </tr>
            </c:forEach>
        </tbody>  
