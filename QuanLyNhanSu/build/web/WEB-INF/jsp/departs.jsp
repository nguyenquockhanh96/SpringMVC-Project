...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item">
                            <a href="departs.htm?lang=en">English</a> | <a href="departs.htm?lang=vi">Việt nam</a>
                        </li>
                        <div class="dropdown">
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold"><spring:message code="lable.home.li4" text="Thêm phòng ban"/></h1>
                        <br>
                        <br>
                        <br>
                        <br>

                        <form action="departs.htm" method="post" modelAttribute="departins" role="form" class="contactForm">
                            <c:set var="departins" value="${departins}"></c:set>
                                <div class="form-row" style="color: red">

                                    <div class="form-group col-md-6">
                                        <input type="text" class="form-control" name="id" value="${departins.id}" id="email" placeholder="mã phòng ban" data-rule="minlen:2" text="Mã phòng ban"/>
                                    <div class="validation"></div>
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="text" name="name" value="${departins.name}" class="form-control" id="name" placeholder="tên phòng ban" data-rule="minlen:1" text="Tên phòng ban"/>
                                    <div class="validation"></div>
                                </div>
                            </div>
                            ...
                            <div class="form-row" style="color: red">
                                ...
                                <div class="text-center" style="padding-left: 386px; padding-top: 24px; padding-bottom: 24px;"><button class="btn btn-outline-success my-2 my-sm-0" name="btnInsertDP" type="submit"><spring:message code="btn.add" text="Thêm"/> </button> &nbsp;&nbsp;&nbsp;<button class="btn btn-outline-success my-2 my-sm-0" name="btnReset" type="submit"><spring:message code="btn.add5" text="Làm mới"/></button></div>
                            </div> 
                        </form>
        ...
        <br>
        <br>
        <table class="bordered" id="dataTable" cellspacing="0"  style="width:100%"> 
            <div >
                <thead >
                    <tr>
                        <th  >mã phòng ban</th>
                ...
                <c:forEach var="a" items="${departsins}">
                    <tr>
                        <td ><label>${a.id}</label></td>
