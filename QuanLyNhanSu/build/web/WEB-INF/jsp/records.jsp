            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item">
                        <a href="records.htm?lang=en">English</a> | <a href="records.htm?lang=vi">Việt nam</a>
                        </li>
                        <div class="dropdown">
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold"><spring:message code="lable.home.li5" text="Thêm thành tích"/></h1>
                        <br>
                        <br>
                        <br>
                        <br>
                        ...
                        <form action="records.htm" method="post" modelAttribute="recordins" role="form" class="contactForm">
                            <c:set var="staff" value="${staff}"></c:set>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input readonly="" hidden="" type="text" class="form-control" name="from" value="phongautomail@gmail.com"/>
                                    <div class="validation"></div>
                                </div>
                            </div> 
                            <div class="form-row" style="color: red">
